  ...
  <div class="main">
    <div class="searchWarp">
      <el-card class="box-card">
        <my-select :areaList="areaList" :lineList="lineList" @chidrenFnOne="selectValuearea" @chidrenFnTwo="selectValueline" type-all="1" title="位置" />
        <my-select :areaList="OnlypriceList" :lineList="allpriceList" @chidrenFnOne="selectValueonly" @chidrenFnTwo="selectValueall" type-all="1" title="价格" />
        <my-select :mylist="typeArea" @chidrenFnthree="typeAreaselect" type-all="2" title="户型" />
        <my-select :mylist="mainjiArea" @chidrenFnthree="typeAreaselect" type-all="2" title="面积" />
        <my-select :shuomingArray="shuomingArray" :optionsArray="optionsList" @chidrenFnfour="getSelectValue" type-all="3" title="更多" />
      </el-card>
    </div>
    <div class="contWarp">
      ...
      <div class="contWarp-fr">
        ...
        <new-img :newimgList="imgList" word-orimg="1" />
      </div>
    </div>
  </div>
</template>
